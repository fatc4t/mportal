...
<link rel="stylesheet" href="../css/order/bootstrap.min_h.css">
<link rel="stylesheet" href="../css/order/slidebars/slidebars.min_h.css">
<link rel="stylesheet" href="../css/order/mp_style_h.css">
...
<link rel="stylesheet" href="../css/order/bootstrap.min.css">
<link rel="stylesheet" href="../css/order/slidebars/slidebars.min.css">
<link rel="stylesheet" href="../css/order/mp_style.css">
...
<script src="../js/order/jquery/jquery.min.js"></script>
<script src="../js/order/slidebars/slidebars.min.js"></script>
<script src="../js/order/slidebars/mp_silde.js"></script>
...
<?php // 配列$fileNameの拡張子を見てｃｓｓかｊｓか判別して読み込み
    foreach ($fileNames as $fileName) 
    {
        ...
        {
            echo('<link rel="stylesheet" type="text/css" href="../css/order/'.$fileName .'">'.PHP_EOL);
        }
        elseif(strstr($fileName,'.js'))
        {
            echo('<script type="text/javascript" src="../js/order/'.$fileName .'"></script>'.PHP_EOL);
        }
    }
?>
<!--[if lt IE 9]>
