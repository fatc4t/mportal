<?php
    ...
    class SetPulldown extends FwSetPulldown
    {
        ...
        public function getAccessIDList( $urlKey, $authority )
        {
            ...
            // アクセス可能な組織IDリストを作成
            $mAccessList = $this->securityProcess->getAccessAuthorityListForUrl( SystemParameters::$V_DR_HOME );
            
            $organList = $this->securityProcess->getAccessDisplayOrderHierarchy( $mAccessList[$authority], $_SESSION["DRM_ACCESS_AUTHORITY_TABLE"][$urlKey] );
