...
<script src="../js/master/jquery/jquery.min.js"></script>
<script src="../js/master/slidebars/slidebars.min.js"></script>
<script src="../js/master/slidebars/mp_silde.js"></script>
...
<?php // 配列$fileNameの拡張子を見てｃｓｓかｊｓか判別して読み込み
    foreach ($fileNames as $fileName) 
    {
        ...
        {
            echo('<link rel="stylesheet" type="text/css" href="../css/master/'.$fileName .'">'.PHP_EOL);
        }
        elseif(strstr($fileName,'.js'))
        {
            echo('<script type="text/javascript" src="../js/master/'.$fileName .'"></script>'.PHP_EOL);
        }
    }
?>
<!--[if lt IE 9]>
