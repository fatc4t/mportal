...
$notice_contact_id = (isset($_GET['notice_contact_id'])) ? $_GET['notice_contact_id'] : "";

$sql  = " SELECT * ";
$sql .= "   FROM ".$schema.".t_notice_contact";
$sql .= "  WHERE notice_contact_id =".$notice_contact_id;
...
if($f_rows){
        while($f_row = $f_rows[$cnt]) {
            ...
            // 添付画像
            // ディレクトリのパスを記述
            $dir = "../../noticeContact/server/php/".$schema.'/'.$f_row['thumbnail'].'/'  ;
