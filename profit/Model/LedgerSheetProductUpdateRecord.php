<?php
     ...
     */
    class LedgerSheetProductUpdateRecord extends BaseModel
    {
        /**
         * コンストラクタ
         */
        ...
        private function creatSQL( $postArray, &$searchArray )
        {
            ...
            $sql  = " SELECT
                    ...
                    prod_kn,
                    CASE WHEN
                        prod_capa_nm = '' THEN (SELECT prod_capa_kn)
                    ...
                    order_lot,
                    CASE WHEN 
                        prod_tax_type = '2' THEN (SELECT saleprice_ex)
                        ELSE (SELECT saleprice) 
                    END AS saleprice,
                    v.abbreviated_name,
                    fixeprice
