<?php
     ...
     */
    class LedgerSheetProductDelayedUpdate extends BaseModel
    {
        /**
         * コンストラクタ
         */
        ...
        private function creatSQL( $postArray, &$searchArray )
        {
            ...
            {
                $where .= ' where date(change_dt) >= date(:start_date) ';
            ...
            {
                $where .= ' AND date(change_dt) <= date(:end_date) ';
            ...
            $sql  = " SELECT DISTINCT
                    ...
                    prod_kn,
                    CASE WHEN
                        prod_capa_nm = '' OR prod_capa_nm IS NULL THEN (SELECT prod_capa_kn)
                    ...
                    order_lot,
                    return_lot,
                    date(change_dt) AS change_dt,
                    date(a.insdatetime) AS insdatetime,
                    b.sect_nm,
                    v.abbreviated_name
                
                    FROM mst0211 a
                    JOIN mst1201 b ON a.sect_cd = b.sect_cd
