<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetSalesResults.php';
     ...
     */
    class LedgerSheetSalesResultsController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetSalesResults = new LedgerSheetSalesResults();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetSalesResults->get_data();
            $org_id_list       = [];
            ...
            require_once './View/LedgerSheetSalesResultsPanel.html';
