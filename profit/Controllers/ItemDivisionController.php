<?php
     ...
     */
    class ItemDivisionController extends BaseController
    {
        /**
         * コンストラクタ
         */
        ...
        public function inputAreaAction()
        {
            ...
            require_once './View/ItemDivisionInputPanel.html';
        }
        ...
        private function initialDisplay()
        {
            ...
            require_once './View/ItemDivisionPanel.html';
        }
        ...
        private function initialList( $addFlag, $messege = "MSG_BASE_0000")
        {
            ...
            {
                // 成功一覧表更新
                require_once './View/ItemDivisionTablePanel.html';
            }
            else
            {
                // エラーメッセージを表示
