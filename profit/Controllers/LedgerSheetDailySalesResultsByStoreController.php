<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetDailySalesResultsByStore.php';
     ...
     */
    class LedgerSheetDailySalesResultsByStoreController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        public function csvoutputAction()
        {
            ...
            header("Content-Disposition: attachment; filename=店別売上日報".mb_convert_encoding(basename($file_path), 'SJIS-win', 'UTF-8').";" );
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetDailySalesResultsByStore = new LedgerSheetDailySalesResultsByStore();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetDailySalesResultsByStore->get_data();
            $org_id_list       = [];
            ...
            require_once './View/LedgerSheetDailySalesResultsByStorePanel.html';
