<?php
     ...
     */
    class DepartmentClassificationController extends BaseController
    {
        /**
         * コンストラクタ
         */
        ...
        public function inputAreaAction()
        {
            ...
            require_once './View/DepartmentClassificationInputPanel.html';
        }
        ...
        private function initialDisplay()
        {
            ...
            require_once './View/DepartmentClassificationPanel.html';
        }
        ...
        private function initialList( $addFlag, $messege = "MSG_BASE_0000")
        {
            ...
            {
                // 成功一覧表更新
                require_once './View/DepartmentClassificationTablePanel.html';
            }
            else
            {
                // エラーメッセージを表示
