<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetCustomerPayementResults.php';
     ...
     */
    class LedgerSheetCustomerPayementResultsController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        public function csvoutputAction()
        {
            ...
            header("Content-Disposition: attachment; filename=顧客支払実績一覧".mb_convert_encoding(basename($file_path), 'SJIS-win', 'UTF-8').";" );
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetCustomerPayementResults = new LedgerSheetCustomerPayementResults();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetCustomerPayementResults->get_data();
            $org_id_list       = [];
            ...
            require_once './View/LedgerSheetCustomerPayementResultsPanel.html';
