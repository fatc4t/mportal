<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetSalesByProvider.php';
     ...
     */
    class LedgerSheetSalesByProviderController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        public function csvoutputAction()
        {
            ...
            header("Content-Disposition: attachment; filename=仕入先別実績".mb_convert_encoding(basename($file_path), 'SJIS-win', 'UTF-8').";" );
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetSalesByProvider = new LedgerSheetSalesByProvider();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetSalesByProvider->get_data();
            $org_id_list    = [];
            ...
            require_once './View/LedgerSheetSalesByProviderPanel.html';
