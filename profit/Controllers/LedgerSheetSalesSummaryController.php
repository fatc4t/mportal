<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetSalesSummary.php';
     ...
     */
    class LedgerSheetSalesSummaryController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        public function csvoutputAction()
        {
            ...
            header("Content-Disposition: attachment; filename=単品売上集計表".mb_convert_encoding(basename($file_path), 'SJIS-win', 'UTF-8').";" );
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetSalesSummary = new LedgerSheetSalesSummary();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetSalesSummary->get_data();
            $org_id_list    = [];
            ...
            $spe_sales_lst  = [];
            $spe_sales_lst  = $ledgerSheetSalesSummary->getspe_sales_list();
            $spe_sales_detail = [];
            $spe_sales_detail = $ledgerSheetSalesSummary->getspe_sales_detail();
            ...
            require_once './View/LedgerSheetSalesSummaryPanel.html';
