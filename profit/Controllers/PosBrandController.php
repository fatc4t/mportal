<?php
     ...
     */
    class PosBrandController extends BaseController
    {
        /**
         * コンストラクタ
         */
        ...
        public function inputAreaAction()
        {
            ...
            require_once './View/PosBrandInputPanel.html';
        }
        ...
        private function initialDisplay()
        {
            ...
            require_once './View/PosBrandPanel.html';
        }
        ...
        private function initialList( $addFlag, $messege = "MSG_BASE_0000")
        {
            ...
            {
                // 成功一覧表更新
                require_once './View/PosBrandTablePanel.html';
            }
            else
            {
                // エラーメッセージを表示
