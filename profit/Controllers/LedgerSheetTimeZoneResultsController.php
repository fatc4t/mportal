<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetTimeZoneResults.php';
     ...
     */
    class LedgerSheetTimeZoneResultsController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetTimeZoneResults = new LedgerSheetTimeZoneResults();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetTimeZoneResults->get_data();
            //print_r($data);
            $org_id_list       = [];
            ...
            require_once './View/LedgerSheetTimeZoneResultsPanel.html';
