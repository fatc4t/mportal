<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetDailySalesResults.php';
     ...
     */
    class LedgerSheetDailySalesResultsController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        public function csvoutputAction()
        {
            ...
            header("Content-Disposition: attachment; filename=売上日別実績".mb_convert_encoding(basename($file_path), 'SJIS-win', 'UTF-8').";" );
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetDailySalesResults = new LedgerSheetDailySalesResults();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetDailySalesResults->get_data();
            $org_id_list       = [];
            ...
            require_once './View/LedgerSheetDailySalesResultsPanel.html';
