<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetCostAnomalies.php';
     ...
     */
    class LedgerSheetCostAnomaliesController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        public function csvoutputAction()
        {
            ...
            header("Content-Disposition: attachment; filename=原価異常一覧表".mb_convert_encoding(basename($file_path), 'SJIS-win', 'UTF-8').";" );
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetCostAnomalies = new LedgerSheetCostAnomalies();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetCostAnomalies->get_data();
            $org_id_list    = [];
            ...
            require_once './View/LedgerSheetCostAnomaliesPanel.html';
