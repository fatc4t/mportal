<?php
    ...
    // コスト帳票処理モデル
    require './Model/LedgerSheetTransitionResult.php';
     ...
     */
    class LedgerSheetTransitionResultController extends BaseController
    {
        /**
         * コンストラクタ
         */
 ...
 /**
        ...
        private function initialDisplay($mode)
        {
            ...
            $ledgerSheetTransitionResult = new LedgerSheetTransitionResult();
            $modal = new Modal();

            // 帳票フォーム一覧データ取得
            $data           = [];
            $data           = $ledgerSheetTransitionResult->get_data();
            $org_id_list    = [];
            ...
            require_once './View/LedgerSheetTransitionResultPanel.html';
