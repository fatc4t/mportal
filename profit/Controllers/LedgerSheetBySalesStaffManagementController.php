<?php
    ...
    // Login処理モデル
    require './Model/LedgerSheetBySalesStaffManagement.php';

    /**
     * 表示項目設定コントローラクラス
     * @note   表示項目設定の新規登録/修正/削除を行う
     */
    class LedgerSheetBySalesStaffManagementController extends BaseController
    {
        /**
         * コンストラクタ
         */
        ...
        public function pdfoutputAction()
        {
            ...
            $ledgerSheetBySalesStaffManagement = new ledgerSheetBySalesStaffManagement();
            ...
            //テスト用
            //$html = file_get_contents("./View/LedgerSheetBySalesStaffManagementPDFPanel.html");
            ...
            $list = $ledgerSheetBySalesStaffManagement->getFormListData($searchArray);
...
// modal            
            ...
            $abbreviatedNameList = $ledgerSheetBySalesStaffManagement->setPulldown->getSearchOrganizationList( 'reference' );      // 組織略称名リスト
...
// modal            
            ...
            //$sort = ($mode === "initial") ? 'organization_name#1' : parent::escStr( $_POST['sort'] );
            $searchArray = array(
            ...
            if($mode != "initial") {
                // 帳票フォーム一覧データ取得
                $searchArray = $_POST;
                $ledgerSheetDetailList = $ledgerSheetBySalesStaffManagement->getFormListData($searchArray);
                ...
                if(count($ledgerSheetDetailList) > 0){
                    ...
                    foreach($ledgerSheetDetailList as $data){
                        $sumCustAmount  = $sumCustAmount + $data["cust_amount"];
                        ...
                        $sumday_costprice += $data["day_costprice"];
                    }
            ...
            $searchArray['staff_cd'] = str_replace("'","",$_POST['staff_cd']);
            ...
            {
                require_once './View/LedgerSheetBySalesStaffManagementPanel.html';
            }
        }
        ...
        public function csvoutputAction()
        {
            ...
            header("Content-Disposition: attachment; filename=担当者別売上管理表".mb_convert_encoding(basename($file_path), 'SJIS-win', 'UTF-8').";" );
