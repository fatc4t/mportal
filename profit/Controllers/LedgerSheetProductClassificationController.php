<?php
    ...
    // Login処理モデル
    require './Model/LedgerSheetProductClassification.php';

    /**
     * 表示項目設定コントローラクラス
     * @note   表示項目設定の新規登録/修正/削除を行う
     */
    class LedgerSheetProductClassificationController extends BaseController
    {
        /**
         * コンストラクタ
         */
        ...
        private function initialDisplay($mode)
        {
            ...
            $LedgerSheetProductClassification = new LedgerSheetProductClassification();
            $modal = new Modal();
            $org_id_list    = [];
            ...
            $data = '';
            if($_POST){
                $data = $LedgerSheetProductClassification->getFormListData($_POST);
            }
            ...
            {
//print_r(searchArray);
                require_once './View/LedgerSheetProductClassificationPanel.html';
            }
        }
