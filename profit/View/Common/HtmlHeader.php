...
<script src="../js/profit/jquery/jquery.min.js"></script>
<script src="../js/profit/slidebars/slidebars.min.js"></script>
<script src="../js/profit/slidebars/mp_silde.js"></script>

<!-- ゆっくりTOPに上げる -->
<script src="../js/mp_slow_up.js"></script>

<!-- 年月のDatePickerを使用する為のInclude-->
<script type="text/javascript" src="../js/profit/common.js"></script>
...
<?php // 配列$fileNameの拡張子を見てｃｓｓかｊｓか判別して読み込み
    foreach ($fileNames as $fileName) 
    {
        ...
        {
            echo('<link rel="stylesheet" type="text/css" href="../css/profit/'.$fileName .'">'.PHP_EOL);
        }
        elseif(strstr($fileName,'.js'))
        {
            echo('<script type="text/javascript" src="../js/profit/'.$fileName .'"></script>'.PHP_EOL);
        }
    }
?>
<!--[if lt IE 9]>
