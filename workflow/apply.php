...
//		$workflow_html .= "</tr>\n";
		...
		if ($workflow_id != 0 && $r_file_name1 != ""){	//再申請
			...
			$workflow_html .= "<td align=left width=720>".$r_file_name1.$r_kakuchousi1."&nbsp;&nbsp;<button type=\"button\" onclick=\"location.href='apply.php?workflow_id=".$workflow_id."&tenp_del=1&remand=".$remand."&tenp_del_1=".$tenp_del_1."&tenp_del_2=".$tenp_del_2."&tenp_del_3=".$tenp_del_3."'\">削除</button></td>\n";
			$workflow_html .= "</tr>\n";
		}else{
			$workflow_html .= "<tr>\n";
			$workflow_html .= "<th align=center rowspan=3 width=100>添付ファイル</th>\n";
			$workflow_html .= "<th align=center width=100>1</th>\n";
			$workflow_html .= "<td align=left width=720><input id=\"userfile1\" name=\"userfile1\" type=\"file\" /></td>\n";
			$workflow_html .= "</tr>\n";
		}
