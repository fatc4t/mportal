...
if ($remand == 0){
		$form1_html .= "<form id=\"apply\" method=\"post\" enctype=\"multipart/form-data\" action=\"apply.php?home=".$home."&cd=1&tenp_del_1=".$tenp_del_1."&tenp_del_2=".$tenp_del_2."&tenp_del_3=".$tenp_del_3."\">\n";
}else{
		$form1_html .= "<form id=\"apply\" method=\"post\" enctype=\"multipart/form-data\" action=\"apply.php?home=".$home."&cd=1&remand=2&workflow_id=".$workflow_id."&tenp_del_1=".$tenp_del_1."&tenp_del_2=".$tenp_del_2."&tenp_del_3=".$tenp_del_3."\">\n";
}
		$workflow_html .= "<table>\n";
		$workflow_html .= "<tbody>\n";
		$workflow_html .= "<tr>\n";
...
//フローを表示
		...
		$button_html .= "<input type=\"button\" onclick=\"check(".$remand.",".$tenp_del_1_f.",".$tenp_del_2_f.",".$tenp_del_3_f.")\" value=\"申請\" class=\"request\" />\n";
