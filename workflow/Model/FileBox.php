<?php
    ...
    class TopMessage extends BaseModel
    {
        ...
        private function creatSQL( $postArray, &$searchArray )
        {
            ...
            // サムネイル
            if( !empty( $postArray['thumbnail'] ) )
            {
                $sql .= ' AND thumbnail LIKE :thumbnail ';
                $thumbnail = "%" . $postArray['thumbnail'] . "%";
                $searchArray = array_merge($searchArray, array(':thumbnail' => $thumbnail,));
            }
        ...
        private function creatSortSQL( $sortNo )
        {
            ...
            $sortSqlList = array(
                                ...
                                4    => ' ORDER BY title, registration_time DESC',
                                5    => ' ORDER BY contents DESC, registration_time DESC',
                                6    => ' ORDER BY contents, registration_time DESC',
                                7    => ' ORDER BY thumbnail DESC, registration_time DESC',
                                8    => ' ORDER BY thumbnail, registration_time DESC',
                                9    => ' ORDER BY file DESC, registration_time DESC',
                                10   => ' ORDER BY file, registration_time DESC',
                                11   => ' ORDER BY viewer DESC, registration_time DESC',
                                12   => ' ORDER BY viewer, registration_time DESC',
                                13   => ' ORDER BY viewer_count DESC, registration_time DESC',
                                14   => ' ORDER BY viewer_count, registration_time DESC',
            );
