<?php
    ...
    class SecurityProcess extends FwSecurityProcess
    {
        ...
        protected function getUrlKey()
        {
            ...
            $keyURL = '';
            // 管理機能メニューがあるか
            if( isset( $_SESSION["S_MANAGEMENT_MENU"] ) )
            {
                $keyURL = $this->getControllerUrlKey( $_SESSION["S_MANAGEMENT_MENU"], $controllerName );
                if( '' !== $keyURL )
                {
            ...
            // 勤怠機能メニューがあるか
            if( isset( $_SESSION["S_TOP_MENU"] ) )
            {
                $keyURL = $this->getControllerUrlKey( $_SESSION["S_TOP_MENU"], $controllerName );
                if( '' !== $keyURL )
                {
                    $Log->trace("END getUrlKey");
                    return $keyURL;
