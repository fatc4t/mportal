...
<script src="../js/customer/jquery/jquery.min.js"></script>
<script src="../js/customer/slidebars/slidebars.min.js"></script>
<script src="../js/customer/slidebars/mp_silde.js"></script>
...
<?php // 配列$fileNameの拡張子を見てｃｓｓかｊｓか判別して読み込み
    foreach ($fileNames as $fileName) 
    {
        ...
        {
            echo('<link rel="stylesheet" type="text/css" href="../css/customer/'.$fileName .'">'.PHP_EOL);
        }
        elseif(strstr($fileName,'.js'))
        {
            echo('<script type="text/javascript" src="../js/customer/'.$fileName .'"></script>'.PHP_EOL);
        }
    }
?>
<!--[if lt IE 9]>
