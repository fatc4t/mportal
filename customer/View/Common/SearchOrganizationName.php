...
?>
                                    ...
                                    <!-- ajax差し替えエリア -->
                                    <div id="jquery-replace-SearchOrganizationName-ajax" style='display: inline-block; _display: inline;'>
                                            <?php $selectOrgSize = empty( $selectOrgSize ) ? 100 : $selectOrgSize  ?>
                                            <select name="organizationName" id="organizationName" style="width:<?php hsc($selectOrgSize); ?>px">
