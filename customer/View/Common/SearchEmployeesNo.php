...
?>
                                    ...
                                    <!-- ajax差し替えエリア -->
                                    <div id="jquery-replace-SearchEmployeesNo-ajax" style='display: inline-block; _display: inline;'>
                                        <select name="userNo" id="userNo" style="width: 100px">
                                            <?php foreach($userNoList as $user) { ?>
                                                ...
                                                <?php } ?>
                                                <option value="<?php hsc($user['employees_no']); ?>" <?php hsc($selected); ?>><?php hsc($user['employees_no']); ?>&nbsp;&nbsp;<?php hsc($user['user_name']); ?></option>
                                            <?php } ?>
                                        </select>
