...
?>
    ...
    <div class="sb-slidebar sb-left">
        <nav>
            <ul class="sb-menu">
                <li><img src="../img/logo-profit.png" alt="Slidebars" width="118" height="40"></li>
                <li class="sb-close"><a href="<?php hsc(SystemParameters::$V_P_TOP); ?>">トップページ</a></li>
                ...
                <div id="drop_menu1">
                    <?php 
                        foreach( $_SESSION["REPORT_MENU"] as $key => $val )
                        {
                ...
                <div id="drop_menu2">
                    <?php 
                        foreach( $_SESSION["LEDGER_SHEET_MENU"] as $key => $val )
                        {
                            if( false !== array_key_exists ( $key, $_SESSION["ACCESS_MENU_LIST"] ) )
                            {
                    ?>
                ...
                <div id="drop_menu">
                    <?php 
                        foreach( $_SESSION["P_MANAGEMENT_MENU"] as $key => $val )
                        {
                            //if( false !== array_key_exists ( $key, $_SESSION["ACCESS_MENU_LIST"] ) )
                            //{
                    ?>
