...
?>
<?php
    echo '<!-- HtmlHeader.php GetCurrentWorkingDirectory:'.getcwd().' -->'.PHP_EOL;
?>
...
<script src="../js/product/jquery/jquery.min.js"></script>
<script src="../js/product/slidebars/slidebars.min.js"></script>
<script src="../js/product/slidebars/mp_silde.js"></script>
...
<?php
/*
<!-- 年月のDatePickerを使用する為のInclude-->
<script type="text/javascript" src="../js/product/common.js"></script>
<script type="text/javascript" src="../js/product/jquery-ui.min.js"></script>
<link rel="stylesheet" type="text/css" href="../css/master/jquery-ui.css">
 */
?>
...
<?php // 配列$fileNameの拡張子を見てｃｓｓかｊｓか判別して読み込み
  if (isset($fileNames) === true){
    foreach ($fileNames as $fileName) 
    {
        ...
        {
            echo('<link rel="stylesheet" type="text/css" href="../css/product/'.$fileName .'">'.PHP_EOL);
        }
        elseif(strstr($fileName,'.js'))
        {
            echo('<script type="text/javascript" src="../js/product/'.$fileName .'"></script>'.PHP_EOL);
        }
    }
  }
?>
