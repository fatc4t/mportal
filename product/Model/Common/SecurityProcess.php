<?php
    ...
    class SecurityProcess extends FwSecurityProcess
    {
        ...
        protected function getUrlKey()
        {
            ...
            $keyURL = '';
            // 管理機能メニューがあるか
            if( isset( $_SESSION["C_MANAGEMENT_MENU"] ) )
            {
                $keyURL = $this->getControllerUrlKey( $_SESSION["C_MANAGEMENT_MENU"], $controllerName );
                if( '' !== $keyURL )
                {
            ...
            // トップ画面のメニューがあるか
            if( isset( $_SESSION["C_TOP_MENU"] ) )
            {
                $keyURL = $this->getControllerUrlKey( $_SESSION["C_TOP_MENU"], $controllerName );
            }
