...
<script src="../js/home/jquery/jquery.min.js"></script>
...
<?php // 配列$fileNameの拡張子を見てｃｓｓかｊｓか判別して読み込み
    if($fileNames){
        foreach ($fileNames as $fileName) 
        {
            ...
            {
                echo('<link rel="stylesheet" type="text/css" href="../css/home/'.$fileName .'">'.PHP_EOL);
            }
            elseif(strstr($fileName,'.js'))
            {
                echo('<script type="text/javascript" src="../js/home/'.$fileName .'"></script>'.PHP_EOL);
            }
        }
    }
?>
